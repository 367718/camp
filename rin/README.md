...
On first access to any parameter, a file with the executable name and the "rn" extension will be loaded from the current directory. The data will be kept in memory.
